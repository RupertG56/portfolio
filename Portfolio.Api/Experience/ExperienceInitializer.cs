    ...
    public async Task InitializeAsync()
    {
        ...
        var experiences = new List<ExperienceDocument>
        {
            new()
            {
                ...
                - Served as a role model for the team by demonstrating a strong work ethic, commitment to excellence, professionalism, and adherence to company values at all times.
            ...
            new()
            {
              ...
              ResponsibilityMarkdown =
              """
                - Built, maintained, and extended CapNet using C# .NET. Implemented the frontend application following MVVM in WPF.
                ...
                - Designed and implemented the system (DAPS - Data Acquisition and Provisioning Server) to handle automated setup of VoIP accounts for mobile app VoIP using REST APIs.
            ...
            new()
            {
                ...
                ResponsibilityMarkdown =
                """
                - Improved software efficiency through extensive profiling and debugging.
